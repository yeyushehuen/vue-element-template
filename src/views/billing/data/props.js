...
export default {
  ...
  columns: [
    { prop: 'accountName', width: 120, label: '店铺名称' },
    { prop: 'country', width: 120, label: '国家' },
    { prop: 'deptName', width: 120, label: '部门' },
    { prop: 'period', width: 120, label: '期间' },
    { prop: 'originDate', width: 150, label: '当地时间', formatter: row => parseTime(row.originDate, '{y}-{m}-{d}') },
    { prop: 'unifyDate', width: 150, label: '转换时间', formatter: row => parseTime(row.unifyDate, '{y}-{m}-{d}') },
    { prop: 'settlementId', width: 150, label: '结算号' },
    { prop: 'type', width: 150, label: '类型' },
    { prop: 'orderId', width: 150, label: '订单号', formatter: textFormatter('orderId') },
    { prop: 'sku', width: 150, label: 'Seller SKU', formatter: textFormatter('sku') },
    ...
    { prop: 'marketplace', width: 150, label: '市场', formatter: textFormatter('marketplace') },
    { prop: 'fulfillment', width: 150, label: '发货方式', formatter: textFormatter('fulfillment') },
    { prop: 'orderCity', width: 150, label: '订单城市', formatter: textFormatter('orderCity') },
    { prop: 'orderState', width: 150, label: '所属政区', formatter: textFormatter('orderState') },
    { prop: 'orderPostal', width: 150, label: '邮编', formatter: textFormatter('orderPostal') },
    { prop: 'taxCollectionModel', width: 150, label: '税收模式', formatter: textFormatter('taxCollectionModel') },
    ...
    { prop: 'exchangeRate', width: 150, label: '汇率', align: 'right', type: 'number', formatter: generateFormater('exchangeRate') },
